...
| [11](11-compare-two-logs.md) | 2026-09-03 | 이전/이후 로그 2개를 넣어 IO 별 차이 보기 | `115b910` |
| [12](12-selection-groups-align.md) | 2026-09-04 | 선택 방식 개편, 그룹화, 레일 겹침 수정, 비교 정렬·구분·존재 차이 | `6aa615e` |
| [13](13-loading-feedback-and-fixes.md) | 2026-09-04 | 읽는 중 표시(배경 스레드), 레일 겹침 재수정, 클릭 시 기존 선택 유지 | `c530a4a` |
| [14](14-layout-audit-zoom-yscale.md) | 2026-09-04 | 겹침 전수 정리, 화살표 버튼 라벨, 완만한 확대, 세로 눈금 고정 | `5145387` |
...
| [24](24-value-axis-zoom.md) | 2026-09-08 | 값 축 확대, "변화만" 눈금, 겹쳐보기 눈금 어긋남 수정 (0.01) | `4b572a7` |
| [25](25-flat-timestamps-and-win7.md) | 2026-09-08 | 같은 시각이 반복되는 로그, Windows 7·10·11 지원 (0.02) | `80486e3` |
| [26](26-faster-open.md) | 2026-09-09 | 로그 여는 시간 — 표를 옮겨 담지 않게 (0.03) | (이 커밋) |
